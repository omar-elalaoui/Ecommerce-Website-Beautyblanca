...
<section class="panel">
    ...
    <div class="panel-body">
        <form enctype="multipart/form-data" class="form-horizontal form-bordered" method="post" action="{{url('/admin/produits')}}">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input name="prix_avant" type="number" class="form-control" required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">Prix vente</label>
                <div class="col-md-6">
                    <input name="prix_vente" type="number" class="form-control" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input name="qnt_stock" type="number" class="form-control" required>
                </div>
            </div>
            ...
            <div class="form-group images-eco">
                ...
                <div class="col-md-9 imgs">
                    <label style="border: 2px solid green;">
                        <input type="file" name='image1' onchange="readURL(this, 'img1_eco');" />
                        <img id="img1_eco" src="http://placehold.it/80" alt="image" />
                    </label>
                    <label>
                        <input type="file" name='image2' onchange="readURL(this, 'img2_eco');" />
                        <img id="img2_eco" src="http://placehold.it/80" alt="image" />
                    </label>
                    <label>
                        <input type="file" name='image3' onchange="readURL(this, 'img3_eco');" />
                        <img id="img3_eco" src="http://placehold.it/80" alt="image" />
                    </label>
                    <label>
                        <input type="file" name='image4' onchange="readURL(this, 'img4_eco');" />
                        <img id="img4_eco" src="http://placehold.it/80" alt="image" />
                    </label>
                </div>
            </div>
...
{{--                    <div  data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'>Start typing...</div>--}}
            ...
            <div class="text-center">
                ...
                <a class="btn btn-default" href="{{url('/admin/produits')}}"><i class="fas fa-times"></i> Annuler</a>
            </div>
        </form>
    </div>
</section>
